...
const AddEmployee = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append("account_number", employee.account_number);
      formDataToSend.append("ifsc", employee.ifsc);
      formDataToSend.append("bank_name", employee.bank_name);
      formDataToSend.append("account_holder_name", employee.account_holder_name);
  ...
  return (
    <div>
      <div className="flex bg-white px-8 py-8 shadow-md rounded-md">
        ...
        <div className="w-full lg:w-1/3 xl:w-1/3 p-4">
        <div className="flex flex-col items-start w-full mt-2">
          <div className="text-blue-600 text-base">Bank Account Number</div>
          <div className="w-full mt-2">
            <input
              name="account_number"
        ...
        <div className="flex flex-col items-start w-full mt-2">
          <div className="text-blue-600 text-base">Bank IFSC Number</div>
          <div className="w-full mt-2">
            <input
              name="ifsc"
              value={employee.ifsc}
              placeholder="Please enter Bank IFSC Number"
              type="text"
              className="py-2 px-2 border border-blue-600 rounded-sm w-full"
              onChange={handleChange}
            ></input>
        ...
        <div className="flex flex-col items-start w-full mt-2">
          <div className="text-blue-600 text-base">Bank Name</div>
          <div className="w-full mt-2">
            <input
              name="bank_name"
        ...
        <div className="flex flex-col items-start w-full mt-2">
          <div className="text-blue-600 text-base">Account Holder Name</div>
          <div className="w-full mt-2">
            <input
